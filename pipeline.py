...
class Pipeline:
    ...
    def process(self, img):
        ...
        gradx = th.abs_sobel_thresh(undistorted_img, orient='x', sobel_kernel=ksize, thresh=(20, 100))
        grady = th.abs_sobel_thresh(undistorted_img, orient='y', sobel_kernel=ksize, thresh=(20, 100))
        mag_binary = th.mag_thresh(undistorted_img, sobel_kernel=ksize, mag_thresh=(30, 170))
        dir_binary = th.dir_threshold(undistorted_img, sobel_kernel=ksize, thresh=(0, np.pi / 2))
        ...
        self.perspectiveTrafo = pt.PerspectiveTrafo(combined)
